...
export default function Home2() {
  ...
  return (
    <div className="p1t1_container">
     ...
     <h1 className="p1_t1_h1"> Welcome to the Learning Phase 2 / Task 1</h1>

    <h2 className="p1_t1_h1_2">In this phase, you are going to learn on sound change produced in the stem by suffixation. You can click to "continue" button at the end of
...
the language. Those which occur only in certain words are:   </h5>
